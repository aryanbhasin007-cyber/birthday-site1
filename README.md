...
<head>
  <meta charset="UTF-8">
  <title>Happy Birthday Sonal!🎉</title>
  <style>
    body {
      margin: 0;
    ...
    #startPage, #slideshowPage, #wishPage {
      display: none;
...
<body>
  ...
  <div id="wishPage">
    ...
    Sonal, thank you for being the kind of friend who knows all my secrets, all my embarrassing moments, 
